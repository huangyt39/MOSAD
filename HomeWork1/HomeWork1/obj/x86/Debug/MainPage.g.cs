            ...
            IMainPage_Bindings
        {
            ...
            private void Update_(global::HomeWork1.Model.ItemList obj, int phase)
            {
                if (obj != null)
                {
                    ...
                    {
                        this.Update_pub_img(obj.pub_img, phase);
                        this.Update_pub_title(obj.pub_title, phase);
                    }
                }
            }
            private void Update_pub_img(global::Windows.UI.Xaml.Media.ImageSource obj, int phase)
            {
            ...
            private void Update_pub_title(global::System.String obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
